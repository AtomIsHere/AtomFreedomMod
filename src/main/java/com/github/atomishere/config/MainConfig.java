package com.github.atomishere.config;
...
public class MainConfig extends PluginComponent<AtomFreedomMod>
{
    ...
    public MainConfig(AtomFreedomMod plugin)
    {
        super(plugin);
    ...
    {
        return plugin.getResource(AtomFreedomMod.CONFIG_FILENAME);
    }
