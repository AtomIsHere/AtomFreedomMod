package com.github.atomishere.admin;
...
public class AdminList extends FreedomService
{
    ...
    public AdminList(AtomFreedomMod plugin)
    {
        super(plugin);
    ...
    public void deactivateOldEntries(boolean verbose)
    {
        for (Admin admin : allAdmins.values())
        {
            ...
            if (verbose)
            {
                FUtil.adminAction("AtomFreedomMod", "Deactivating superadmin " + admin.getName() + ", inactive for " + lastLoginHours + " hours", true);
            }
