package com.github.atomishere.player;
...
import com.github.atomishere.caging.CageData;
import com.github.atomishere.config.ConfigEntry;
import com.github.atomishere.freeze.FreezeData;
...
public class FPlayer
{
    ...
    public FPlayer(AtomFreedomMod plugin, Player player)
    {
        this(plugin, player.getName(), Ips.getIp(player));
    }

    private FPlayer(AtomFreedomMod plugin, String name, String ip)
    {
        this.plugin = plugin;
        this.name = name;
        this.ip = ip;
    ...
    public void startArrowShooter(AtomFreedomMod plugin)
    {
