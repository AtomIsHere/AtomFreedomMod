...
import com.github.atomishere.httpd.HTMLGenerationTools;
...
public class Module_schematic extends HTTPDModule
{
    ...
    public Module_schematic(AtomFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String title()
    {
        return "AtomFreedomMod :: Schematic Manager";
    }
