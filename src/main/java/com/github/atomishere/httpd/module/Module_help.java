...
public class Module_help extends HTTPDModule
{
    ...
    public Module_help(AtomFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String getBody()
    {
        ...
        while (it.hasNext())
        {
            ...
            {
                if (!AtomFreedomMod.pluginName.equals(pluginName))
                {
    ...
    {
        return "AtomFreedomMod :: Command Help";
    }
